...
fun DateRangePickerExample() {
  ...
  'bar-chart-defaults': {
    ...
    description: 'Default factory methods for all bar chart configuration objects.',
    image: null,
    androidImport: 'com.developerstring.jetco.ui.charts.barchart.BarChartDefaults',
    kmpImport: 'com.developerstring.jetco_kmp.charts.barchart.BarChartDefaults',
    params: [
      { name: 'columnBarChartConfig()', type: 'BarChartConfig', default: '—', description: 'Returns default BarChartConfig.' },
      { name: 'groupBarChartConfig()', type: 'GroupBarChartConfig', default: '—', description: 'Returns default GroupBarChartConfig.' },
      { name: 'yAxisConfig()', type: 'YAxisConfig', default: '—', description: 'Returns default YAxisConfig.' },
      { name: 'xAxisConfig()', type: 'XAxisConfig', default: '—', description: 'Returns default XAxisConfig.' },
      { name: 'gridLineStyle()', type: 'GridLineStyle', default: '—', description: 'Returns default GridLineStyle.' },
      { name: 'popUpConfig()', type: 'PopUpConfig', default: '—', description: 'Returns default PopUpConfig.' },
    ],
    codeExamples: {
      android: `import com.developerstring.jetco.ui.charts.barchart.BarChartDefaults

// Use factory methods to get default configurations
val barConfig = BarChartDefaults.columnBarChartConfig(
    color = Color(0xFF6C5CE7),
    height = 200.dp
)

val yAxis = BarChartDefaults.yAxisConfig(
    axisScaleCount = 5,
    textPrefix = "$"
)`,
      kmp: `import com.developerstring.jetco_kmp.charts.barchart.BarChartDefaults
...
val yAxis = BarChartDefaults.yAxisConfig(
  ...
  'line-graph-defaults': {
    ...
    category: 'Configuration',
    description: 'Default factory methods for all line graph configuration objects.',
    image: null,
    androidImport: 'com.developerstring.jetco.ui.charts.linegraph.LineGraphDefaults',
    kmpImport: 'com.developerstring.jetco_kmp.charts.linegraph.LineGraphDefaults',
    params: [
      { name: 'lineConfig()', type: 'LineGraphLineConfig', default: '—', description: 'Returns default line config.' },
      { name: 'pointConfig()', type: 'LineGraphPointConfig', default: '—', description: 'Returns default point config.' },
      { name: 'areaConfig()', type: 'LineGraphAreaConfig', default: '—', description: 'Returns default area config.' },
      { name: 'animationConfig()', type: 'LineGraphAnimationConfig', default: '—', description: 'Returns default animation config.' },
      { name: 'liveUpdateConfig()', type: 'LineGraphLiveUpdateConfig', default: '—', description: 'Returns default live update config.' },
      { name: 'yAxisConfig()', type: 'LineGraphYAxisConfig', default: '—', description: 'Returns default Y-axis config.' },
      { name: 'xAxisConfig()', type: 'LineGraphXAxisConfig', default: '—', description: 'Returns default X-axis config.' },
      { name: 'popUpConfig()', type: 'LineGraphPopUpConfig', default: '—', description: 'Returns default pop-up config.' },
      { name: 'gridLineStyle()', type: 'LineGraphGridLineStyle', default: '—', description: 'Returns default grid line style.' },
    ],
    codeExamples: {
      android: `import com.developerstring.jetco.ui.charts.linegraph.LineGraphDefaults

val lineConfig = LineGraphDefaults.lineConfig(
    lineColor = Color(0xFF6C5CE7),
    smoothCurve = true,
    curvature = 0.4f
)

val liveConfig = LineGraphDefaults.liveUpdateConfig(
    enabled = true,
    blinkColor = Color.Red
)`,
      kmp: `import com.developerstring.jetco_kmp.charts.linegraph.LineGraphDefaults
...
val liveConfig = LineGraphDefaults.liveUpdateConfig(
  ...
  'candlestick-defaults': {
    ...
    category: 'Configuration',
    description: 'Default factory methods and color constants for candlestick chart configuration.',
    image: null,
    androidImport: 'com.developerstring.jetco.ui.charts.candlestickchart.CandlestickDefaults',
    kmpImport: 'com.developerstring.jetco_kmp.charts.candlestickchart.CandlestickDefaults',
    params: [
      { name: 'candleConfig()', type: 'CandlestickCandleConfig', default: '—', description: 'Returns default candle config.' },
      { name: 'gridLineStyle()', type: 'CandlestickGridLineStyle', default: '—', description: 'Returns default grid line style.' },
      { name: 'animationConfig()', type: 'CandlestickAnimationConfig', default: '—', description: 'Returns default animation config.' },
      { name: 'defaultBullishColor', type: 'Color', default: 'Color.Green', description: 'Default bullish candle color.' },
      { name: 'defaultBearishColor', type: 'Color', default: 'Color.Red', description: 'Default bearish candle color.' },
    ],
    codeExamples: {
      android: `import com.developerstring.jetco.ui.charts.candlestickchart.CandlestickDefaults

val candleConfig = CandlestickDefaults.candleConfig()
val bullish = CandlestickDefaults.defaultBullishColor
val bearish = CandlestickDefaults.defaultBearishColor`,
      kmp: `import com.developerstring.jetco_kmp.charts.candlestickchart.CandlestickDefaults
...
val bearish = CandlestickDefaults.defaultBearishColor`,
  ...
  'pie-chart-defaults': {
    ...
    category: 'Configuration',
    description: 'Default factory methods for pie chart configuration objects.',
    image: null,
    androidImport: 'com.developerstring.jetco.ui.charts.piechart.PieChartDefaults',
    kmpImport: 'com.developerstring.jetco_kmp.charts.piechart.PieChartDefaults',
    params: [
      { name: 'pieChartConfig()', type: 'PieChartConfig', default: '—', description: 'Returns default PieChartConfig (radius=75.dp, thickness=25.dp).' },
      { name: 'pieChartAnimationConfig()', type: 'PieChartAnimationConfig', default: '—', description: 'Returns default animation config (duration=1000, rotations=11).' },
    ],
    codeExamples: {
      android: `import com.developerstring.jetco.ui.charts.piechart.PieChartDefaults

val config = PieChartDefaults.pieChartConfig(
    radius = 100.dp,
    thickness = 35.dp,
    enableChartItems = true
)

val animConfig = PieChartDefaults.pieChartAnimationConfig(
    animationDuration = 1500
)`,
      kmp: `import com.developerstring.jetco_kmp.charts.piechart.PieChartDefaults
...
val animConfig = PieChartDefaults.pieChartAnimationConfig(
  ...
  'picker-defaults': {
    name: 'PickerDefaults',
    category: 'Configuration',
    description: 'Default factory methods for wheel picker configuration objects.',
    image: null,
    androidImport: 'com.developerstring.jetco.ui.components.picker.PickerDefaults',
    kmpImport: 'com.developerstring.jetco_kmp.components.picker.PickerDefaults',
    params: [
      { name: 'wheelPickerConfig()', type: 'WheelPickerConfig', default: '—', description: 'Returns default wheel picker config.' },
      { name: 'headerConfig()', type: 'HeaderConfig', default: '—', description: 'Returns default header config.' },
      { name: 'datePickerConfig()', type: 'DatePickerConfig', default: '—', description: 'Returns default date picker config.' },
      { name: 'containerConfig()', type: 'ContainerConfig', default: '—', description: 'Returns default container config.' },
      { name: 'dateRangePickerConfig()', type: 'DateRangePickerConfig', default: '—', description: 'Returns default date range picker config.' },
    ],
    codeExamples: {
      android: `import com.developerstring.jetco.ui.components.picker.PickerDefaults

val wheelConfig = PickerDefaults.wheelPickerConfig()
val headerConfig = PickerDefaults.headerConfig()
val dateConfig = PickerDefaults.datePickerConfig()`,
      kmp: `import com.developerstring.jetco_kmp.components.picker.PickerDefaults
